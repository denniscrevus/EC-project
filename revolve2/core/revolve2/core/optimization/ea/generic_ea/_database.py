...
class DbEAOptimizer(DbBase):
    ...
    dist_objective_table = Column(String, nullable=False)
    power_objective_table = Column(String, nullable=False)
    nr_of_joints_table = Column(String, nullable=False)
...
class DbEAOptimizerIndividual(DbBase):
    ...
    distance_obj_id = Column(Integer, nullable=True)
    remaining_power_id = Column(Integer, nullable=True)
    number_of_joints_id = Column(Integer, nullable=True)
